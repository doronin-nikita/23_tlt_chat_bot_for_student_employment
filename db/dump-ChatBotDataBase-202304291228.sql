...
INSERT INTO `студенты` VALUES (324169971,'имфиит',NULL,1,2,1);
...
IF mID not in (select id from студенты) THEN
        ...
        RETURN "Приветствую, укажите ваш институт или специальность если вы являетесь студентом, если вы не студент рекамендуем отключть бота, т.к. функций для других пользователей, добавлено небыло.";
    END IF;
...
-- Dump completed on 2023-04-29 12:28:23
